    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory', models.IntegerField(null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('customers_liked', models.ManyToManyField(blank=True, related_name='product_customer_liked', through='store.Likes', to='store.customer')),
        ...
        migrations.AddField(
            model_name='likes',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='liked_product', to='store.product'),
        ),
        migrations.AddField(
